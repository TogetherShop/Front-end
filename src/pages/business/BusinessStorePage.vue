    ...
    <div class="container d-flex flex-column bg-white min-vh-100 shadow mx-auto app-wrapper p-0">
      ...
      <div class="container-fluid px-3 py-3">
        <div class="page-title mb-3">
          <h5 class="mb-0 fw-bold">제휴업체</h5>
        </div>

        <div class="text-center py-5">
          <span class="material-symbols-outlined display-1 text-muted mb-3">handshake</span>
          <h6 class="text-muted">제휴업체 페이지</h6>
          <p class="text-muted small">향후 개발 예정</p>
        </div>
      </div>
